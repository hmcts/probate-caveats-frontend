...
const healtcheckFunc = function(req, res) {
...
router.get(`${config.app.basePath}/health`, (req, res) => healtcheckFunc(req, res));
router.get('/health', (req, res) => healtcheckFunc(req, res));
